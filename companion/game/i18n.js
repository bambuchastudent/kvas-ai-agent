...
export const GAME_I18N = Object.freeze({
  ru: {
    htmlLang: "ru", locale: "ru-RU", pageTitle: "КВАССИСТЕНТ 28 · Глобальные запуски",
    description: "КВАССИСТЕНТ 28: игра с глобусом, шестью континентами и бутылками-ракетами.",
    back: "← НА ГЛАВНУЮ", versionLabel: "ВЕРСИЯ 28", language: "Язык", soundOn: "Звук: вкл.", soundOff: "Звук: выкл.",
  ...
  en: {
    htmlLang: "en", locale: "en-GB", pageTitle: "KVASSISTENT 28 · Global launches",
    description: "KVASSISTENT 28: a globe game with six continents and bottle rockets.",
    back: "← HOME", versionLabel: "VERSION 28", language: "Language", soundOn: "Sound: on", soundOff: "Sound: off",
  ...
  es: {
    htmlLang: "es", locale: "es-ES", pageTitle: "KVASSISTENT 28 · Lanzamientos globales",
    description: "KVASSISTENT 28: juego con globo, seis continentes y botellas cohete.",
    back: "← INICIO", versionLabel: "VERSIÓN 28", language: "Idioma", soundOn: "Sonido: sí", soundOff: "Sonido: no",
  ...
  de: {
    htmlLang: "de", locale: "de-DE", pageTitle: "KVASSISTENT 28 · Globale Starts",
    description: "KVASSISTENT 28: Globusspiel mit sechs Kontinenten und Flaschenraketen.",
    back: "← STARTSEITE", versionLabel: "VERSION 28", language: "Sprache", soundOn: "Ton: an", soundOff: "Ton: aus",
  ...
  "zh-CN": {
    htmlLang: "zh-CN", locale: "zh-CN", pageTitle: "KVASSISTENT 28 · 全球发射",
    description: "KVASSISTENT 28：带有六大洲和瓶子火箭的地球游戏。",
    back: "← 返回主页", versionLabel: "第 28 版", language: "语言", soundOn: "声音：开", soundOff: "声音：关",
  ...
  el: {
    htmlLang: "el", locale: "el-GR", pageTitle: "KVASSISTENT 28 · Παγκόσμιες εκτοξεύσεις",
    description: "KVASSISTENT 28: παιχνίδι με υδρόγειο, έξι ηπείρους και μπουκάλια-πυραύλους.",
    back: "← ΑΡΧΙΚΗ", versionLabel: "ΕΚΔΟΣΗ 28", language: "Γλώσσα", soundOn: "Ήχος: ναι", soundOff: "Ήχος: όχι",
